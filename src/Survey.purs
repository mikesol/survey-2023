...
survey = Survey
  ...
  , CheckSeveralResponse
      ...
      (HasOther true)
  , CheckSeveralResponse
      (Question "What tools do you use for bundling code generated by the PureScript JS backend?")
  ...
  , CheckSeveralResponse
      ...
      (HasOther false)
  , FreeFormResponse
      (Question "What PureScript backends, if any, would you like to see improved in the next 12 months (ie JS, Erlang, Python, Go)? Why? Would you be comfortable contributing to their maintenance?")
  , FreeFormResponse
      (Question "What PureScript backends, if any, would you like to see implemented in the next 12 months (ie Scheme, Rust)? Why? Would you be comfortable contributing to the implementation?")
  , CheckSeveralResponse
      ( Question
